...
inline std::unordered_map<std::string_view, ConfigItem> config {
     ...
     CONFIGITEM("Legit>LegitBot>Default>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>Pistol>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>Heavy Pistol>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>Rifle>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>SMG>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>Scout>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>AWP>Distance FOV", false),
     ...
     CONFIGITEM("Legit>LegitBot>Heavy>Distance FOV", false),
     ...
     CONFIGITEM(
          "Visuals>Players>Enemies>Chams>Backtrack Color", ImColor(197, 66, 245, 255)),
     CONFIGITEM("Visuals>Players>Enemies>Chams>Trail", false),

     CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Material", 0),
     CONFIGITEM(
          "Visuals>Players>Teammates>Chams>Visible Color", ImColor(197, 66, 245, 255)),
     ...
     CONFIGITEM(
          "Visuals>Players>Teammates>Chams>Occluded Color", ImColor(197, 66, 245, 255)),
     ...
     CONFIGITEM(
          "Visuals>Players>LocalPlayer>Weapon Overlay Color", ImColor(197, 66, 245, 255)),
     ...
     CONFIGITEM(
          "Visuals>Players>LocalPlayer>Arms Overlay Color", ImColor(197, 66, 245, 255)),
     ...
     CONFIGITEM(
          "Visuals>Players>LocalPlayer>Sleeve Overlay Color", ImColor(197, 66, 245, 255)),
     ...
     CONFIGITEM("Misc>Skins>Skins>PaintKit", 0), CONFIGITEM("Misc>Skins>Skins>Wear", 0),
        ...
        switch (i.second.type) {
            ...
            case COLOR:
                configFile << i.second.type << "\t" << i.first << "\t"
                           << i.second.colValue.Value.x << "|" << i.second.colValue.Value.y
...
inline void load() {
    ...
    while (std::getline(configFile, line)) {
        ...
        try {
            ...
            Log::log(ERR,
                 "Failed to load config item %s, probably due to an out of date config, "
                 "just redo the selected item and save again.",
                 name);
        }
    }
}
